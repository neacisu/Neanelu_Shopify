...
void describe('Module D: prod_proposals table', { skip: SKIP }, () => {
  ...
  void it('has all required columns', async () => {
    ...
    assert.ok(columnNames.includes('field_path'), 'should have field_path');
    assert.ok(columnNames.includes('proposed_value'), 'should have proposed_value');
    assert.ok(columnNames.includes('proposal_status'), 'should have proposal_status');
...
void describe('Module D: prod_dedupe_clusters table', { skip: SKIP }, () => {
  ...
  void it('has all required columns', async () => {
    ...
    assert.ok(columnNames.includes('id'), 'should have id');
    assert.ok(columnNames.includes('cluster_type'), 'should have cluster_type');
...
void describe('Module D: prod_similarity_matches table', { skip: SKIP }, () => {
  ...
  void it('has all required columns', async () => {
    ...
    assert.ok(columnNames.includes('similarity_score'), 'should have similarity_score');
    assert.ok(columnNames.includes('match_method'), 'should have match_method');
    assert.ok(columnNames.includes('match_confidence'), 'should have match_confidence');
  });

  void it('has primary key constraint', async () => {
    ...
    assert.ok(pk, 'should have primary key constraint');
  });
...
void describe('Module D: prod_quality_events table', { skip: SKIP }, () => {
  ...
  void it('has all required columns', async () => {
    ...
    assert.ok(columnNames.includes('quality_score_before'), 'should have quality_score_before');
    assert.ok(columnNames.includes('quality_score_after'), 'should have quality_score_after');
    assert.ok(columnNames.includes('trigger_reason'), 'should have trigger_reason');
  });
